...
* pip (comes with Python, but can be updated if needed)
  ```sh
  python -m pip install --upgrade pip
  ```
* An IDE, preferably [Visual Studio Code](https://code.visualstudio.com/) or [PyCharm](https://www.jetbrains.com/pycharm/)
